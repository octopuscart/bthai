                        ...
                        <tbody>
                            <tr>
                                <td style="    text-align: center;font-size: 18px;">
                                    ...
                                    <p>
                                        Welcome to Baan Thai <span style='color:red'>Spice Club</span><br/>
                                        Earn cash vouchers based on numbers of visits to Baan Thai ! 
                                    </p>
                                    ...
                                    <table style="font-size: 12px;    font-size: 15px;
                                        ...
                                        <tr>
                                            ...
                                            <td style="    text-align: left;"><?php echo $appointment['address']; ?></td>
                                        </tr>
                                    ...
                                    <img src="<?php echo base_url(); ?>assets/images/loyalprogram2.jpg" style="margin: 10px;   background: white;width: 100%;"/>
